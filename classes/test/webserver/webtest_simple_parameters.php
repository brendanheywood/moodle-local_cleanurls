 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class webtest_simple_parameters extends webtest {
    /**
     * @return string
     */
    public function get_name() {
        return 'Test rewrite with a simple parameter';
    }
    ...
    public function get_description() {
        return 'Clean URLs should work when extra parameters in query string are supplied.';
    }
