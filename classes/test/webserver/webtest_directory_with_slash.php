 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class webtest_directory_with_slash extends webtest {
    /**
     * @return string
     */
    public function get_name() {
        return 'Fetch an existing directory with slash';
    }
    ...
    public function get_description() {
        return 'When fetching an directory with the trailing slash the request should not go through Clean URLs.';
    }
