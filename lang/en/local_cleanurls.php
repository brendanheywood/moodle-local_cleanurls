...
$string['analyser_notfound'] = 'not found';
...
$string['cachedef_outgoing'] = 'Clean URLs mapping: uncelan to clean.';
$string['cachedef_incoming'] = 'Clean URLs mapping: clean to unclean.';
$string['invalid_path_alreadyused'] = 'This path is already being used by: {$a}.';
$string['invalid_path_modulename'] = 'Invalid subpath, it is reserved for a course module name.';
$string['path_header'] = 'Clean URLs';
$string['path_setting'] = 'Activity Subpath';
$string['path_setting_help'] = 'Custom path to use in the URL for this activity.';
